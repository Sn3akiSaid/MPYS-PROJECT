...
set output "DatayLAHWSM.pdf"
plot "band_partition_LAH_WSM_1.dat" u 1:2:4 w l ls 1 lc palette notitle, \
     "band_partition_LAH_WSM_1.dat" u 1:6:8 w l lw 2 lc palette notitle
