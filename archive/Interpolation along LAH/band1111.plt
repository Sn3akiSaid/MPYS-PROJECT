...
set output "interpolated_orbitals10.pdf"
...
# Use `for` within a single `plot` command
plot for [i=1:20] sprintf("band_partition_%d.dat", i) u 1:2 w l lc rgb "red" lw 1 notitle, \
